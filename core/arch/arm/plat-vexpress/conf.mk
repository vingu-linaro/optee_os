...
CFG_SCMI_SERVER_PRODUCT=fvp
CFG_SCMI_SERVER_CLOCK ?= y
CFG_SCMI_SERVER_SYSTEM_PLL ?= y
CFG_SCMI_SERVER_POWER_DOMAIN ?= y
CFG_SCMI_SERVER_PERF ?= y
CFG_SCMI_SERVER_MOCK_PSU ?= y
CFG_SCMI_SERVER_DVFS ?= y
CFG_SCMI_SERVER_SENSOR ?= y
CFG_SCMI_SERVER_NOTIFICATION ?= y
CFG_SCMI_SENSOR_EVENTS ?= y
CFG_SCMI_SERVER_IRQ ?= y
